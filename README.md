...
D4rnet - Gameplay programming and game design. ShkiperD3 - UX/UI and game design. darkmagicmods - Level design and game disign

Character progression — built the hero stat structure (HP, Speed, Damage) as an extensible base so new items and upgrades could hook into it without reworking the system.
